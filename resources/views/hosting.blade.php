    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            @forelse($hostingProducts as $product)
                ...
                @endphp
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 {{ $isPopular ? 'border-2 border-xperts-orange shadow-xl' : 'border border-slate-200 dark:border-gray-700 shadow-lg' }} card-hover {{ $isPopular ? 'relative' : '' }}">
                    @if($isPopular)
                    ...
                    <div class="mt-4 mb-6">
                        <span class="text-4xl font-bold dark:text-white">{{ $currency === 'KES' ? 'KSh ' : '$' }}{{ number_format($price, $currency === 'KES' ? 0 : 2) }}</span><span class="text-slate-500">/mo</span>
                    </div>
            ...
            @empty
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-slate-200 dark:border-gray-700 shadow-lg card-hover">
                    ...
                    <div class="mt-4 mb-6"><span class="text-4xl font-bold dark:text-white">$3</span><span class="text-slate-500">/mo</span></div>
                    <ul class="space-y-3 text-slate-600 dark:text-gray-400">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border-2 border-xperts-orange shadow-xl card-hover relative">
                    ...
                    <div class="mt-4 mb-6"><span class="text-4xl font-bold dark:text-white">$15</span><span class="text-slate-500">/mo</span></div>
                    <ul class="space-y-3 text-slate-600 dark:text-gray-400">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-slate-200 dark:border-gray-700 shadow-lg card-hover">
                    ...
                    <div class="mt-4 mb-6"><span class="text-4xl font-bold dark:text-white">$25</span><span class="text-slate-500">/mo</span></div>
                    <ul class="space-y-3 text-slate-600 dark:text-gray-400">
                        <li class="flex items-center gap-2"><svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Unlimited Storage</li>
